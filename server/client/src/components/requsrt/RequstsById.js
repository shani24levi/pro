...
import { getMyRequstes } from '../../actions/requsteActions';
import '../../App.css'

class RequstesById extends Component {
  componentDidMount() {
    this.props.getMyRequstes();
  }
...
RequstesById.propTypes = {
  getMyRequstes: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { getMyRequstes })(RequstesById);
