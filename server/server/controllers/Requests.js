...
const Requests =require('../models/Requests');
     ...
     async function craeteRequst(req,res){
        try{
            ...
            if(String(user1Exist)==String(user2Exist)) 
                return res.status(402).send({message: 'User cant sent to himself'});
     ...
     async function deleteAllRequsts(req,res){
        try{
     ...
     async function deleteOneRequsts(req,res){
        try{
     ...
     async function getAllRequsts(req,res){
        try{
    ...
    async function getMyRequsts(req,res){
        try{
             const allRequsts = await Requests.find({resiving:req.user._id}).populate('sending resiving apartmnt', 'first_name last_name address city');; //get the details     
            if (!allRequsts) {
                res.status(404).json({message: 'Requsts not found'});
            } else {
                res.status(200).json( allRequsts)
    ...
    async function getRequstsById(req,res){
        try{
    ...
    async function getRequstsByUserId(req,res){
        try{
    ...
    async function getRequstsByApartment(req,res){
        try{
    ...
    async function getRequstsByOwner(req,res){
        try{
    ...
    async function updetOneRequsts(req,res){
        try{
